...
<div id="page">
 <div id="left_style">
  ...
  <div class="Classify">
   <ul>
    <c:forEach items="${strings}" var="d" varStatus="status">
			<li><a href="findrecruits?title=${d}"  target="_blank">${d }</a></li>
 ...
 <div id="right_style">
   ...
   <div id="Recruit">
      ...
      <c:forEach items="${recruits}" var="d" varStatus="status">
			<ul class="Recruit">
	   <li class="Recruit_title">职位：<span class="Post">${d.title}</span> 招聘人数：${d.num}人 <span class="time">发布时间：<fmt:formatDate value='${d.createTime}' pattern="yyyy-MM-dd"/></span></li>
	   <li class="Recruit_Request ">
	     <p>要求:</p>
		 <p>${d.content}</p>
		
	   </li>
	   <li class="btn_link "><a href="${bbs }/front/apply?parentId=${d.id }" class="Fill">我要应聘</a><a href="${bbs }/front/Recruitment_Details?id=${d.id }" class="Details">查看详情</a></li>
	  </ul>
...
<script type="text/javascript">
	function page(pageNum){
		window.top.location.href="${bbs}/front/Recruitment?pageNum="+pageNum
	}
