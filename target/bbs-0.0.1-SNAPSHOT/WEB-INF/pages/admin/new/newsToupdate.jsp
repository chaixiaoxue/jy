...
<div class="panel admin-panel">
  <div class="panel-head" id="add11"><strong><span class="icon-pencil-square-o"></span>修改新闻内容</strong></div>
  <div class="body-content">
    ...
    <input name="id" value="${part.id }" hidden="hidden">
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50"  name="title" data-validate="required:新闻标题" value="${part.title }"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
       		<select id="first" name="parentId">
       			<option value="${parentId }">${part.parentId }</option>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button id="update_btn" class="button bg-main icon-check-square-o" type="button" onclick="formSubmit('${bbs}/new/updatenews','_self')"> 修改</button>
