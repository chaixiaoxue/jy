    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li style="float:right">
          <input type="text" placeholder="请输入主题关键字" name="keywords" class="input" style="width:250px; line-height:17px;display:inline-block" />
        ...
        <tr>
          ...
          <td>
	          ...
	          <a class="button border-yellow" href="toview?id=${d.id}">
		          	...
		          	<a class="button border-main" href="toreply?id=${d.id}">
