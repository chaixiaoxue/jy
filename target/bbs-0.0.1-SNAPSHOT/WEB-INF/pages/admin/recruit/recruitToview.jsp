  ...
  <div class="body-content">
    <form method="post" class="form-x" action=""> 
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50"  name="title" readonly="readonly" data-validate="required:招聘主题" value="${part.title }"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="orderNo" name="orderNo" readonly="readonly" value="${part.recruiting }"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="orderNo" name="orderNo" readonly="readonly"/ value="${part.num }">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="orderNo" name="orderNo" readonly="readonly"/ value="${part.money }">
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="orderNo" name="orderNo" readonly="readonly" value="${part.requireddate }"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="clear"></div>    
