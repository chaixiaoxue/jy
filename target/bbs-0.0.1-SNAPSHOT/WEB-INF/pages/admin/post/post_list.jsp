    ...
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
		...
		<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
			...
			<td>
				<fmt:formatDate  value="${p.updateTime}" pattern="yyyy-MM-dd-HH:mm:ss"/>
			</td>
			<td>
				<fmt:formatDate  value="${p.passedTime}" pattern="yyyy-MM-dd-HH:mm:ss"/>
			</td>
			<td>
				<div class="button-group">
					<a class="button border-red" href="${bbs}/post/delete?postId=${p.postId}">
