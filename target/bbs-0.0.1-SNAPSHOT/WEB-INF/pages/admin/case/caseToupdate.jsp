  ...
  <div class="body-content">
    ...
    <input name="id" value="${part.id }" hidden="hidden">
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50"  name="title" data-validate="required:案例名称" value="${part.title }"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button id="update_btn" class="button bg-main icon-check-square-o" type="button" onclick="formSubmit('${bbs}/case/update','_self')"> 修改</button>
