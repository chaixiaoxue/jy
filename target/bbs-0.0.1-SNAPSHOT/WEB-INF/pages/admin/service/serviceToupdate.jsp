...
<div class="panel admin-panel">
  <div class="panel-head" id="add11"><strong><span class="icon-pencil-square-o"></span>修改服务项目信息</strong></div>
  <div class="body-content">
    ...
    <input name="id" value="${part.id }" hidden="hidden">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="parentId" name="parentId" readonly="readonly" value="服务项目信息"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button id="update_btn" class="button bg-main icon-check-square-o" type="button" onclick="formSubmit('${bbs}/service/update','_self')"> 修改</button>
