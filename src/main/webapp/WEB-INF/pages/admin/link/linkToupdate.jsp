...
<div class="panel admin-panel">
  <div class="panel-head" id="add11"><strong><span class="icon-pencil-square-o"></span>修改链接信息</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action=""> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50"  name="title"  data-validate="required:链接名称" value="${part.title }"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50"  name="content"  data-validate="required:链接地址"/ value="${part.content }">
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="parentId" name="parentId"  value="友情链接"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="orderNo" name="createTime" readonly="readonly" value="<fmt:formatDate value='${part.createTime}' pattern="yyyy-MM-dd HH:mm:ss"/>">
          <div class="tips"></div>
        </div>
      </div>
      <div class="clear"></div>    
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button id="update_btn" class="button bg-main icon-check-square-o" type="button" onclick="formSubmit('${bbs}/link/update','_self')"> 保存</button>
