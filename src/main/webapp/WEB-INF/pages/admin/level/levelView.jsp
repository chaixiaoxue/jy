  ...
  <div style="padding:20px">
	     ...
	     <div style="clear:both"></div>
	   	<div style="display:block">
	        ...
	        <div class="field">
	          	<input type="text" class="input w50" name="levelName" value="${level.levelName}" readonly="readonly" />
	          	<div class="tips"></div>
	        </div>
	     </div>
	     <div style="clear:both"></div>
	     <div style="display:block">
	        ...
	        <div class="field">
	          	<input type="text" class="input w50" name="experience" value="${level.experience}" readonly="readonly" />
	          	<div class="tips"></div>
	        </div>
	     </div>
   </div>
