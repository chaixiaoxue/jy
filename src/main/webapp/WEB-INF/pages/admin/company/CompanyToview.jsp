...
<div class="panel admin-panel">
  <div class="panel-head" id="add11"><strong><span class="icon-pencil-square-o"></span>查看公司信息</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action=""> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="orderNo" name="orderNo" readonly="readonly" value="公司信息"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
