    ...
    <form method="post" class="form-x" action=""> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <span class="tips"><font color="red" size="4">${tips}</font></span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button id="update_btn" class="button bg-main icon-check-square-o" type="button" onclick="formSubmit('${bbs}/section/save','_self')"> 保存</button>
          <div class="tips"></div>
        </div>
      </div>
    </form>
